...
2. **Gatilhos Emocionais:** Use medo, curiosidade extrema, utilidade prática ou um desejo profundo.
3. **Contraste/Negação:** Junte duas ideias que não se misturam ou negue uma crença comum (Ex: "A ciência sombria da positividade", "Por que você NÃO DEVE acordar às 5h").
4. **Sem Clickbait Mentiroso:** A promessa do título DEVE ser entregue no roteiro.

## Regras para Thumbnails
A thumbnail não deve repetir o título. Ela deve complementá-lo, contando a outra metade da história.

Para cada título gerado, forneça 2 conceitos visuais detalhados:
- **Elemento principal:** O que está em foco? (Um objeto, uma pessoa, um gráfico?)
- **Expressão/Emoção:** (se houver rostos, qual é a emoção exata?)
